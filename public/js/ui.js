...
export const showIncomingCallDialog = (
  ...
  const callTypeInfo =
    callType === constants.callType.CHAT_PERSONAL_CODE ? "صوتی" : "تصویری";
...
export const showNoStrangerAvailableDiolog = () => {
  const infoDialog = elements.getInfoDialog(
    " در جستجو کاربر...","لطفا کمی صبر کنید در حال پیدا کردن کاربر انلاین"
  );
...
export const showInfoDialog = (preOfferAnswer) => {
  ...
  if (preOfferAnswer === constants.preOfferAnswer.CALL_REJECTED) {
    infoDialog = elements.getInfoDialog(
      "تماس قطع شد","تماس شما از طرف کاربر قطع شد لطفا مجدد تماس بگیرید..."
    );
  }

  if (preOfferAnswer === constants.preOfferAnswer.CALLEE_NOT_FOUND) {
    infoDialog = elements.getInfoDialog(
      "تماس پیدا نشد"," همچین فردی با ایدی زیر پیدا نشد لطفا برسی کنید !!!"
    );
  }

  if (preOfferAnswer === constants.preOfferAnswer.CALL_UNAVAILABLE) {
    infoDialog = elements.getInfoDialog(
      "تماس با این فرد ممکن نیست","احتمالا کاربر با کس دیگه ای صحبت میکند لطفا بعدا تماس بگیرید ...."
    );
  }
...
const showChatCallElements = () => {
  ...
  const dashboardChat=document.getElementById("messenger_blur");
  hideElement(dashboardChat);
  //block panel
  disableDashboard();
};
